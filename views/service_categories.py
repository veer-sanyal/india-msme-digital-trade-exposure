...
st.markdown(
    "The Overview page tracked the headline digitally delivered services total. "
...
st.markdown(
    ...
    f"**{biggest_deficit['indicator_name']}** was the biggest deficit at "
    f"**${biggest_deficit['net_busd']:.0f}B**: Indian firms pay foreign shipping lines, "
...
shift_2005_2022 = m1_share_year[m1_share_year["year"].isin([year_min, year_max])].pivot(
    index="indicator_name", columns="year", values="m1_share_pct"
).rename(columns={year_min: "pct_2005", year_max: "pct_2022"})
shift_2005_2022["delta"] = shift_2005_2022["pct_2022"] - shift_2005_2022["pct_2005"]
shift_2005_2022 = shift_2005_2022.dropna(subset=["delta"]).sort_values("delta", ascending=False)

biggest_shifters = shift_2005_2022.head(3)
shifter_lines = []
...
st.caption(
    ...
    "`data/processed/ebops_isic_crosswalk.csv`. TiSMoS coverage ends 2022; the Overview page "
