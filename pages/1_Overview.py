...
st.set_page_config(
    page_title="Overview | India Digital Services Trade Exposure",
    layout="wide",
)
...
st.title("Overview")
st.caption(
    "India's digitally delivered services trade, 2005 to present. Mode 1 "
    "(cross-border supply) only. Partner: World aggregate."
)
